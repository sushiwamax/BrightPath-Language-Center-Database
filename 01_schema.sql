-- =====================================================================
-- 01_schema.sql
-- BRIGHTPATH LANGUAGE CENTER - FINAL SCHEMA
-- Kế thừa thiết kế giữa kỳ, có 3 thay đổi (xem CHANGE LOG trong report.md):
--   CH01: Thêm cột CLASS_MEETING.MeetingStatus
--   CH02: Thêm bảng STUDENT_CERTIFICATE_AUDIT
--   CH03: Thêm 3 secondary index (đặt trong 07_indexes_explain.sql)
