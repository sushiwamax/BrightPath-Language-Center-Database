-- =====================================================================
-- 04_views.sql
-- Views phục vụ báo cáo (reporting) - không dùng cho ghi dữ liệu.
...
-- ---------------------------------------------------------------------
-- Hạn chế của các view trên
-- ---------------------------------------------------------------------
-- Cả 2 view đều dùng GROUP BY/aggregation và subquery tương quan, nên
-- KHÔNG updatable (không thể INSERT/UPDATE/DELETE trực tiếp qua view).
-- Đây là các view chỉ phục vụ mục đích reporting/truy vấn, mọi thao tác
-- ghi dữ liệu phải thực hiện qua bảng gốc hoặc stored procedure tương ứng.
